/**
 * app/admin/products/[id]/edit/page.tsx — Product details inventory editor
 *
...
type EditFormFields = z.infer<typeof editProductSchema>;
...
export default function EditProductPage({ params }: EditProductPageProps) {
  ...
  // Pre-populate fields once product is loaded
  useEffect(() => {
    if (product) {
      reset({
        name: product.name,
  ...
  if (!product) {
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <h3 className="mt-4 text-base font-bold text-neutral-900 dark:text-white">Product Not Found</h3>
        <p className="mt-2 text-xs text-neutral-500 dark:text-neutral-400">
          The requested product ID does not exist in inventory logs.
        </p>
        <Link
          href="/admin/products"
          className="mt-6 rounded-lg bg-neutral-950 px-4 py-2 text-xs font-semibold text-white hover:bg-neutral-800 dark:bg-white dark:text-neutral-900"
        >
          Return to Inventory
        </Link>
      </div>
  ...
  const onSubmit = async (data: any) => {
    const formData = data as EditFormFields;
    setLoading(true);
    setFormError(null);
    setFormSuccess(null);
    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-neutral-400 dark:text-neutral-500">
          Modify price points, specifications, and descriptions.
        </p>
      </div>
      ...
      <div className="rounded-xl border border-neutral-200 bg-white p-6 shadow-2xs dark:border-neutral-800 dark:bg-neutral-900">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <InputField
            ...
            placeholder="A brief headline highlight..."
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              rows={4}
              placeholder="Provide a detailed overview of manufacturing details..."
